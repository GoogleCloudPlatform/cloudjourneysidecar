...
function buildLinks(){
  var wt = "https://console.cloud.google.com?walkthrough_tutorial_url";
  var gcpquestwt = "https://walkthroughs.googleusercontent.com/content/gcpquest/"
  links.tut_dev1 = wt + "=" + gcpquestwt + "intro_cf.md"; 
  links.tut_sys1 = wt + "=" + gcpquestwt + "intro_ce.md"; 
  links.tut_dsc1 = wt + "=" + gcpquestwt + "intro_bq.md"; 
  links.tut_pro1 = wt + "=" + gcpquestwt + "intro_project.md"; 
}
